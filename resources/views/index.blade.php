...
<html>
<head>
	<title>Notaria Publica No.2</title>
...
<body id="page-top" style="padding-top: 50px;">
	...
	<!---NAVIGATION-->
	<nav class="navbar navbar-default navbar-fixed-top container-nav" style="padding-top: 0px;">
		...
		<div class="col-md-12">
			<div class="content-index">
				<article>
					...
					<h3 style="font-family: SourceSans-Semibold;">Un notario es un funcionario público con estudis end derecho cuya intervención otorga carácter público a los documentos privados y los autoriza a tal fin con su firma.Es un testigo de fe o fedatario público que garantiza la legitimidad de los documentos en los que interviene y proporciona a los ciudadanos la seguridad jurídica en el ámbito extrajudicial. Sus actos se hallan investidos de presunción de verdad, está habilitado por las leyes y reglamentos para conferir fe pública de los contratos y actos extrajudiciales  originados en el marco del derecho privado de la naturaleza civil y mercantil, así como informar y asesorar a los ciudadano en materia de actas públicas sobre hechos, cuestiones testamentarias y derecho hereditario, entre otros.
					Ejerce asismismo una labor en sus actos, lo cual lo distingue de los abogados, quienes deben tomar parte y estar al lado de sus clientes o representados.
					</h3>
...
<div class="main" id="Servicios" >
	...
	<div class="content-information-div-services">
		<div class="subtitle-information-content">
			<h2 class="title-content-information-green">Conozca nuestra gama de servicios</h2>
			<hr class="hr-content-green">
		</div>
		<div style="margin: 0px auto;max-width: 1127px;">
			<div class="row" id="services-content">
				<div class="col-md-3 animated " animated="false">
					<figure>
						...
						<ul class="list-custom-content">
							<li>
								<a href="#form-services" class="item-services" show="0"  title="Constitución de Sociedades"  data-toggle="collapse">Constitución de Sociedades</a>
							</li>
							<li>
								<a href="#form-services" class="item-services" show="0"  title="Fusión"  data-toggle="collapse">Fusión</a>
							</li>
							<li>
								<a href="#form-services" class="item-services" show="0"  title="Transformación"  data-toggle="collapse">Transformación</a>
							</li>
							<li>
				...
				<div class="col-md-3 animated " animated="false">
					<figure>
						...
						<ul class="list-custom-content">
							...
							<li>
								<a href="#form-services" class="item-services" show="0"  title="Testamentos"  data-toggle="collapse">Testamentos</a>
							</li>
							<li>
								<a href="#form-services" class="item-services" show="0"  title="Sucesiones Testamentarias"  data-toggle="collapse">Sucesiones Testamentarias</a>
							</li>
							<li>
				...
				<div class="modal animated bounceInDown" id="myModal" role="dialog">
					<div class="modal-dialog modal-lg">
						...
						<div class="modal-content">
							<div class="modal-header"  style="background-color: #0d3620;color: white;">
							...
							<form>
								...
								<ul style="margin-left: 50px;">
									<li type="disc">Llenar solicitud</li>
									<li type="disc">Generales del testador</li>
									<li type="disc">Identificaciones del testador</li>
								</ul>
								<h3 style="text-align: center;">Formatos de solicitud</h3>
								<div style="margin: 0px auto;max-width: 800px;">
									<div class="row">
										<div class="form-group col-md-4">
											<label for="exampleInputEmail1">Su nombre *</label>
											<input type="text" class="form-control" id="name" name="name" aria-describedby="name" placeholder="Nombre" required>
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-4">
				...
				<div class="col-md-3 animated " animated="false">
					<figure>
						...
						<ul class="list-custom-content">
							<li>
								<a href="#form-services" class="item-services" show="0"  title="Cotejo de documentos y Expedición de copias certificadas"  data-toggle="collapse">Cotejo de documentos y Expedición de copias certificadas</a>
							</li>
							<li>
								<a href="#form-services" class="item-services" show="0"  title="Notificaciones"  data-toggle="collapse">Notificaciones</a>
							</li>
							<li>
								<a href="#form-services" class="item-services" show="0"  title="Interprelaciones"  data-toggle="collapse">Interprelaciones</a>
							</li>
							<li>
								<a href="#form-services" class="item-services" show="0"  title="Fe de hechos"  data-toggle="collapse">Fe de hechos</a>
							</li>
							<li>
...
<div class="main" id="QuienesSomos">
	...
	<div class="we-are-mission-vision-content">
		<div class="row" style="margin: 0px auto;">
			<div class="col-md-12">
			<h2>MISIÓN|VISIÓN</h2>
			<hr class="hr-content-green">
...
<div class="main" id="NuestrosClientes">
	...
	<div class="our-clients-content">
		<div class="row">
			<div class="col-md-12">
				<h3 class="title-content-information-greey">Durante el tiempo que tienen de operar la notaría ha tenido oportunidad de atender múltiples clientes institucionales y particulares entre los que destacan los siguientes:</h3>
			</div>
		</div>
		<div class="row">
...
<div class="main" id="Formatos" style=""></br>
	...
	<div class="formats-content-div" style="margin-bottom: 10pc;">
		<div class="row" style="margin-bottom: 100px;margin-top: 50px;">
			<div class="col-md-12">
				<h3 class="title-content-information-greey">Por favor escríbanos al siguiente correo para solicitar el formato del trámite que desea realizar:</h3>
			</div>
		</div>
		<div class="emails-content">
			<div class="row check-email" >
				<div class="col-md-12 margin-left: 30%;" style="">
					<span class="img-email" style="float: left;display: none;"><img src="img/mayor.png" alt="inicio.png" width="24" height="24"></span>
					<div style="width: 100%;margin-left: 24px;height: 100%;position: relative;">
						<h3 style="float: left;margin-top: 0px;" class="title-content-information-greey">titular@notaria2colima.com.mx</h3>
					</div>
				</div>
			</div>
			<div class="row check-email">
				<div class="col-md-12 margin-left: 30%;" >
					<span class="img-email" style="float: left;display: none;"><img src="img/mayor.png" alt="inicio.png" width="24" height="24"></span>
					<div style="width: 100%;margin-left: 24px;height: 100%;position: relative;">
					<h3 style="float: left;margin-top: 0px;" class="title-content-information-greey">adscrito@notaria2colima.com.mx</h3>
				</div>
				</div>
			</div>
			<div class="row check-email">
				<div class="col-md-12 margin-left: 30%;" >
					<span class="" style="float: left;display: none;"><img src="img/mayor.png" alt="inicio.png" width="24" height="24"></span>
					<div style="width: 100%;margin-left: 24px;height: 100%;position: relative;">
					<h3 style="float: left;margin-top: 0px;" class="title-content-information-greey">recepcion@notaria2colima.com.mx</h3>
				</div>
				</div>
			</div>
		</div>
...
<div class="main" id="Ubicacion">
	<div class="title-information-div" style="">
		<div style=" background-color: #1a4f14bd;width: 100%;    font-family: initial;color: white; height: 283px;position: absolute;">
	...
	<div class="ubication-content-div">
		<div class="row" style="padding-top: 10pc;margin: 0px auto;">
			<div class="col-md-12">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d235.43268740292336!2d-103.72518770653843!3d19.242187359399455!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x84255aab8e3ec15b%3A0x80286bfbf15ce4ad!2sNotar%C3%ADa%20P%C3%BAblica%20No.%202!5e0!3m2!1ses!2smx!4v1571368836288!5m2!1ses!2smx" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>			</div>
		</div>
	</div>
</div>
	...
	<footer>
		<div class="row not-marging-left" style="height: 100%;">
			<div class="col-md-5 right-footer ">
				<img src="img/assets/white_log.png" alt="green_log.png" style="width: 130px;height: 50px;margin: 5px;">
			</div>
			<div class="col-md-7 left-footer">
				<address style="margin-top: 15%;">
					...
					<br>
					<p style="text-align: left;">> Leer aviso de privacidad</p>
				</address>
			</div>
		</div>
		<div class="row sub-footer not-marging-left">
			<div class="col-md-6" style="margin-top: 3%;">
				<p style="text-align: right;">Todos los derechos reservados:Notaría Pública No.2 </p>
			</div>
			<div class="col-md-6" style="margin-top: 3%;">
				<p style="float:left;margin-left: 60px;" align="center">/  Un desarrollo de</p>
				<img style="float:left;margin-left: 20px;" src="img/white-witan.png" align="right" width="110" marginheight="100">
			</div>
		</div>
 	</footer>
</div>
